...
type MonthlyDayProps<DayData> = {
  ...
  renderClick?: (day: Date) => ReactNode;
};
export function MonthlyDay<DayData>({ renderDay, renderClick }: MonthlyDayProps<DayData>) {
  ...
  return (
    <div
      ...
      className="md:rc-h-36 rc-p-2 rc-border-b-2 rc-border-r-2"
    >
